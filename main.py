...
def find_closest_strike(strike_prices, underlying_value):
    if not strike_prices:
        return None  # or return a default value, like underlying_value
    return min(strike_prices, key=lambda x: abs(x - underlying_value))
...
auth_token = "2l5xVwtLGGzRrfjbK218ypRctnz_2wtG9Fd5ZFUwXw6TLWsvX"
